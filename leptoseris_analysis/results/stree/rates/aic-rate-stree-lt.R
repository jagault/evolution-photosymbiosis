...
setwd(here("leptoseris_analysis/results/stree/rates/"))
...
# Read in corHMM runs----------------------------------------------------------
r1 <- readRDS(here("leptoseris_analysis/analysis/stree_corHMM/stree-1rate.rds"))
r2 <- readRDS(here("leptoseris_analysis/analysis/stree_corHMM/stree-2rate.rds"))
r3 <- readRDS(here("leptoseris_analysis/analysis/stree_corHMM/stree-3rate.rds"))
r4 <- readRDS(here("leptoseris_analysis/analysis/stree_corHMM/stree-4rate.rds"))
...
### Model selection~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# AICc weights
daic1 <- 346.0278 - 287.8364
daic2 <- 298.2716 - 287.8364
daic3 <- 287.8364 - 287.8364
daic4 <- 297.7660 - 287.8364
