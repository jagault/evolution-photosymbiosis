...
setwd(here("analysis_rerun/results/mtree/rates/"))
...
# Read in corHMM runs----------------------------------------------------------
r1 <- readRDS(here("analysis_rerun/mtree_corHMM/mtree_1rate/mtree-1rate.rds"))
r2 <- readRDS(here("analysis_rerun/mtree_corHMM/mtree_2rate/mtree-2rate.rds"))
r3 <- readRDS(here("analysis_rerun/mtree_corHMM/mtree_3rate/mtree-3rate.rds"))
...
aics <- cbind(sr1$aic, sr2$aic, sr3$aic)
setnames(aics, c("TH", "HRM+2", "HRM+3"))
